...
public class ActivityOnHospital extends AppCompatActivity {

    Button finish;
    EditText catatan,petugas;
    ...
    public void onCreate( Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_onrs);
        ...
        petugas = (EditText)findViewById(R.id.edt_petugas);

        session = new Session(getApplicationContext());
        session.save(API.POSISITION,"5");
        ...
        finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(!TextUtils.isEmpty(catatan.getText().toString()) && !TextUtils.isEmpty(petugas.getText().toString())){
                    stopTimer();
                    endLoc();
                }else{
    ...
    private void endLoc() {
        ...
        RequestEndLoc.Data data = new RequestEndLoc.Data("67",petugas.getText().toString(),catatan.getText().toString());
        RequestEndLoc params = new RequestEndLoc("0109", data, session.get(API.APIKEY),"b3392645d446ff61bb7b6597d3e7eb98e4866bc6");
        Call<ResponseBody> call = APIInterface.requestEndLoc(params);
        cBack = new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                try {
                    ...
                    if (json.getString("status").compareTo("200") == 0) {
                        ActivityOnHospital.this.finish();
                        startActivity(new Intent(getApplicationContext(), ActivityOtwHome.class));
                    }else {
                        ActivityOnHospital.this.finish();
                        startActivity(new Intent(getApplicationContext(), ActivityOtwHome.class));
                    }
            ...
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                API.retryDialog(ActivityOnHospital.this, call, cBack, 3, true);
            }
        };
        API.enqueueWithRetry(ActivityOnHospital.this, call, cBack, true);
    }
    ...
    private void tracking() {
        ...
        cBack = new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                try {
                    ...
                    if (json.getString("status").compareTo("200") == 0) {
                        ...
                        Toast.makeText(ActivityOnHospital.this, "Username atau password salah", Toast.LENGTH_LONG).show();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                } catch (IOException e) {
            ...
            @Override
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                API.retryDialog(ActivityOnHospital.this, call, cBack, 3, false);
            }
        };
        API.enqueueWithRetry(ActivityOnHospital.this, call, cBack, false);
    }
